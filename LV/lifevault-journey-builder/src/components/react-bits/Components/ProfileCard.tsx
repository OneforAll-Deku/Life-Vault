...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    avatarUrl = 'https://i.pravatar.cc/400?u=javi',
    iconUrl = 'https://res.cloudinary.com/dn7pxrv7m/image/upload/v1738761276/re-spaceman_pkvu01.png',
    grainUrl = 'https://res.cloudinary.com/dn7pxrv7m/image/upload/v1738761276/noise_vstiwv.png',
    innerGradient,
            ...
            <div ref={shellRef} className="relative z-[1] group">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <img
                                className="w-full absolute left-1/2 bottom-[-1px] will-change-transform transition-transform ease-out"
                                src={avatarUrl}
