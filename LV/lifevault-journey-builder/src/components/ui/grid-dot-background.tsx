        ...
        >
            ...
            {showFade && (
                <div
                    ...
                    style={{
                        background: `radial-gradient(ellipse at center, transparent ${fadeIntensity}%, ${currentGridColor === darkGridColor ? "#09090b" : "#ffffff"})`,
                    }}
                />
            )}
        ...
        >
            ...
            {showFade && (
                <div
                    className="pointer-events-none absolute inset-0 flex items-center justify-center"
                    style={{
                        background: `radial-gradient(ellipse at center, transparent ${fadeIntensity}%, ${currentDotColor === darkDotColor ? "#09090b" : "#ffffff"})`,
                    }}
                />
            )}
